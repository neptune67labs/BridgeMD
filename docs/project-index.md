...
- Frameworks: `net8.0`
- Project references: `BridgeMD.Core`, `BridgeMD.Markdown`, `BridgeMD.Roslyn`, `BridgeMD.Syntax`
...
| Type | Role | Layer | Score | Category | Patterns |
| --- | --- | --- | ---: | --- | --- |
| `BridgeMD.Core.AnalysisDiagnostic` | Unknown | Shared | 18 | Low | none |
| `BridgeMD.Core.AnalysisOptions` | Unknown | Shared | 18 | Low | none |
| `BridgeMD.Core.AnalysisSummary` | Unknown | Shared | 18 | Low | none |
...
| `BridgeMD.Core.AnalysisDiagnosticSeverity` | Unknown | Shared | 3 | Low | none |
...
- Frameworks: `net8.0`
- Project references: `BridgeMD.Core`, `BridgeMD.Syntax`
...
- Layer: `Unknown`
- Purpose: Contains Roslyn, Analyzer code.
- Frameworks: `net8.0`
- Project references: `BridgeMD.Core`
- Declared dependencies: `Microsoft.CodeAnalysis.CSharp`
- Technologies: `Roslyn`
- Detected patterns: `Analyzer`

| Type | Role | Layer | Score | Category | Patterns |
| --- | --- | --- | ---: | --- | --- |
| `BridgeMD.Syntax.SyntaxSolutionAnalyzer` | Analyzer | Unknown | 44 | Medium | `Analyzer` |
